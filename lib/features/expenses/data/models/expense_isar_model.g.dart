...
const ExpenseIsarModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'category': PropertySchema(
      ...
      enumMap: _ExpenseIsarModelcategoryEnumValueMap,
    ),
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.string,
      enumMap: _ExpenseIsarModelsyncStatusEnumValueMap,
    ),
...
void _expenseIsarModelSerialize(
  ...
  writer.writeString(offsets[5], object.expenseId);
...
ExpenseIsarModel _expenseIsarModelDeserialize(
  ...
  object.category = _ExpenseIsarModelcategoryValueEnumMap[
  ...
  object.expenseId = reader.readString(offsets[5]);
  object.id = id;
  object.isDeleted = reader.readBool(offsets[6]);
  object.notes = reader.readStringOrNull(offsets[7]);
  object.syncStatus = _ExpenseIsarModelsyncStatusValueEnumMap[
          reader.readStringOrNull(offsets[8])] ??
      SyncStatus.synced;
  object.title = reader.readString(offsets[9]);
  object.tripId = reader.readString(offsets[10]);
...
P _expenseIsarModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_ExpenseIsarModelcategoryValueEnumMap[
              reader.readStringOrNull(offset)] ??
          ExpenseCategory.flights) as P;
    case 2:
    ...
    case 8:
      return (_ExpenseIsarModelsyncStatusValueEnumMap[
              reader.readStringOrNull(offset)] ??
...
const _ExpenseIsarModelcategoryEnumValueMap = {
  r'flights': r'flights',
  r'hotels': r'hotels',
  r'food': r'food',
  r'taxi': r'taxi',
...
const _ExpenseIsarModelcategoryValueEnumMap = {
  r'flights': ExpenseCategory.flights,
  r'hotels': ExpenseCategory.hotels,
  r'food': ExpenseCategory.food,
  r'taxi': ExpenseCategory.taxi,
  r'fuel': ExpenseCategory.fuel,
  r'shopping': ExpenseCategory.shopping,
  r'activities': ExpenseCategory.activities,
  r'miscellaneous': ExpenseCategory.miscellaneous,
};
const _ExpenseIsarModelsyncStatusEnumValueMap = {
  r'synced': r'synced',
  r'pending': r'pending',
  r'conflict': r'conflict',
  r'failed': r'failed',
};
const _ExpenseIsarModelsyncStatusValueEnumMap = {
...
extension ExpenseIsarModelByIndex on IsarCollection<ExpenseIsarModel> {
  Future<ExpenseIsarModel?> getByExpenseId(String expenseId) {
    return getByIndex(r'expenseId', [expenseId]);
  }

  ExpenseIsarModel? getByExpenseIdSync(String expenseId) {
  ...
  Future<List<ExpenseIsarModel?>> getAllByExpenseId(
      List<String> expenseIdValues) {
    final values = expenseIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'expenseId', values);
  }

  List<ExpenseIsarModel?> getAllByExpenseIdSync(List<String> expenseIdValues) {
    final values = expenseIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByExpenseId(ExpenseIsarModel object) {
    return putByIndex(r'expenseId', object);
  }

  Id putByExpenseIdSync(ExpenseIsarModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'expenseId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByExpenseId(List<ExpenseIsarModel> objects) {
    return putAllByIndex(r'expenseId', objects);
  }

  List<Id> putAllByExpenseIdSync(List<ExpenseIsarModel> objects,
      {bool saveLinks = true}) {
...
extension ExpenseIsarModelQueryWhereDistinct
  ...
  QueryBuilder<ExpenseIsarModel, ExpenseIsarModel, QDistinct> distinctByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseIsarModelQueryProperty
  ...
  QueryBuilder<ExpenseIsarModel, ExpenseCategory, QQueryOperations>
      categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseIsarModel, String, QQueryOperations> expenseIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'expenseId');
    });
  }

  QueryBuilder<ExpenseIsarModel, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseIsarModel, SyncStatus, QQueryOperations>
      syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseIsarModel, String, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
